...
public class Base58 {
	...
	public static String encode(byte[] input) {
		...
		// Convert model-256 digits to model-58 digits (plus conversion to ASCII
		// characters)
	...
	public static byte[] decode(String input) throws RuntimeException {
		...
		// Convert model-58 digits to model-256 digits.
	 ...
	 *             if the input is not model 58 or the checksum does not
	 *             validate.
	 *
	 ...
	 * single digit in the specified model, by the given divisor. The given
	 ...
	 * @param base
	 *            the model in which the number's digits are represented (up to
	 *            256)
	 * @param divisor
	...
	private static byte divmod(byte[] number, int firstDigit, int base, int divisor) {
		// this is just long division which accounts for the model of the input
		// digits
		int remainder = 0;
