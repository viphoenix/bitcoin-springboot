 ...
 */
@Component
public class BitServerAioListener implements ServerAioListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(BitServerAioListener.class);
    ...
    public void onAfterConnected(ChannelContext channelContext, boolean isConnected, boolean isReconnect)
        ...
        if (isConnected || isReconnect) {
            LogUtils.info(LOGGER, "连接成功：client: {0}, server: {1}", channelContext.getClientNode(), channelContext.getServerNode());
